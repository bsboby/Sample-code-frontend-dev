...
class Walker_Nav_Menu_Dropdown extends Walker_Nav_Menu {
	...
	function end_el(&$output, $item, $depth){$output .= "</option>\n"; }
	  ...
	  wp_nav_menu(array('menu' => 'about_us','container' => '','menu_class' => ''	,'walker' => new Walker_Nav_Menu_Dropdown(),
	...
	?>
      ...
      <?php
wp_nav_menu(array('menu' => 'About Us','container' => '','menu_class' => 'nav nav-tabs','items_wrap' => '<ul id="%1$s" class="%2$s">%3$s</ul>'));?>
