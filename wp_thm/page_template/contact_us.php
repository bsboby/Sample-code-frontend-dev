...
class Walker_Nav_Menu_Dropdown extends Walker_Nav_Menu {
	...
	function end_el(&$output, $item, $depth){$output .= "</option>\n"; }
	  ...
	  wp_nav_menu(array('menu' => 'contact_us','container' => '','menu_class' => ''	,'walker' => new Walker_Nav_Menu_Dropdown(),
	...
	?>
      ...
      <h3 class="abt-txt">Contact Us</h3>
       <?php
wp_nav_menu(array('menu' => 'contact_us','container' => '','menu_class' => 'nav nav-tabs','items_wrap' => '<ul id="%1$s" class="%2$s">%3$s</ul>'));?>
    </div>
    
    <div class="col-md-2 pull-right flot-cnc">
      <?php dynamic_sidebar('sidebar-5'); ?> 
    </div>
    
    <div class="col-md-8 pull-left flot-cnc">
      <div class="tab-pane">
        <h4><?php the_title(); ?></h4>
        <?php the_content(); ?>
